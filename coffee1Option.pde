//커피1 옵션 클래스 //<>//
class coffee1Option extends Screen{ 
  coffee1Option(){
  ...
  void createObj(){
    ...
    addObj(new Label(60,200,210,350,color(150,200,200),"커피1\n그림1\n500",30));
    ...
    addObj(lbRefund = new Label(30,665,230,690,color(255,255,255),"커피1 "+money+"원",20));
  ...
  void clickEvent(String id){
    ...
    case "시럽추가":
      if (syrupCount > 0) {
        money += 100;
        lbRefund.setString("커피1 "+money+"원");
        syrupCount--;
      }
      break;    
    case "사이즈업":
