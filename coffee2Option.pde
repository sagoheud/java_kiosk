//커피2 옵션 클래스
class coffee2Option extends Screen{ 
  ...
  void createObj(){
    ...
    addObj(new Label(60,200,210,350,color(150,80,200),"커피2\n그림\n600",30));
    ...
    addObj(lbRefund = new Label(30,665,230,690,color(255,255,255),"커피2 "+money+"원",20));
  ...
  void clickEvent(String id){
    ...
    case "시럽추가":
      if (syrupCount > 0) {  
        money += 100;
        lbRefund.setString("커피2 "+money+"원");
        syrupCount--;
      }
      break;    
    case "사이즈업":
