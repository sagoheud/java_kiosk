//음료2 옵션 클래스
class juice2Option extends Screen{
  ...
  void createObj(){
    ...
    addObj(new Label(60,200,210,350,color(150,80,200),"음료2\n그림\n200",30));
    ...
    addObj(lbRefund = new Label(30,665,230,690,color(255,255,255),"음료2 "+money+"원",20));
  ...
  void clickEvent(String id){
    ...
    case "사이즈업":
      if (sizeUpCount > 0) {
        money += 200;
        lbRefund.setString("음료2 "+money+"원");
        sizeUpCount--;
      }
      break;
    case "옵션제거":
