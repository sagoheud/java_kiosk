//음료1 옵션 클래스
class juice1Option extends Screen{
  ...
  void createObj(){
    ...
    addObj(new Label(60,200,210,350,color(150,80,200),"음료1\n그림\n300",30));
    ...
    addObj(lbRefund = new Label(30,665,230,690,color(255,255,255),"음료1 "+money+"원",20));
  ...
  void clickEvent(String id){
    ...
    case "사이즈업":
      if (sizeUpCount > 0) {
        money += 200;
        lbRefund.setString("음료1 "+money+"원");
        sizeUpCount--;
      }
      break;
    case "옵션제거":
